                ...
                <div className=' bg-gray-800 px-8 py-8 rounded-xl w-80 lg:w-96'>
                    ...
                    <div>
                        <input type="text"
                            ...
                            value={products.title} onChange={(e) => setProducts({...products, title: e.target.value }) }
                        />
                    </div>
                    ...
                    <div>
                        <input type="text"
                            ...
                            value={products.price} onChange={(e) => setProducts({...products, price: e.target.value }) }
                        />
                    </div>
                    ...
                    <div>
                        <input type="text"
                            ...
                            value={products.imageUrl} onChange={(e) => setProducts({...products, imageUrl: e.target.value }) }
                        />
                    </div>
